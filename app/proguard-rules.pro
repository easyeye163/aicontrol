...
# Agent 相关（反射/SPI）
-keep class com.aicontrol.android.agent.langchain.http.** { *; }
-keep class com.aicontrol.android.agent.** { *; }

# Tool 注册（反射）
-keep class com.aicontrol.android.tool.** { *; }

# Channel（钉钉/飞书回调，保留泛型签名）
-keep class com.aicontrol.android.channel.** { *; }

...
public class TakeScreenshotTool extends BaseTool {
    ...
    public String getDisplayName() {
        return AiControlApplication.Companion.getInstance().getString(R.string.tool_name_screenshot);
    }
    ...
    public ToolResult execute(Map<String, Object> params) {
        ...
        try {
            ...
            File dir = new File(AiControlApplication.Companion.getInstance().getCacheDir(), "screenshots");

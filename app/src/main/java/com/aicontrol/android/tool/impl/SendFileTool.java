...
import com.aicontrol.android.AiControlApplicationKt;
...
public class SendFileTool extends BaseTool {
    ...
    public String getDisplayName() {
        return AiControlApplication.Companion.getInstance().getString(R.string.tool_name_send_file);
    }
    ...
    public ToolResult execute(Map<String, Object> params) {
        android.content.Context ctx = AiControlApplication.Companion.getInstance();
        // 检查存储权限
        ...
        // 获取当前任务的通道和消息ID
        Channel channel = AiControlApplicationKt.getAppViewModel().getInProgressTaskChannel();
        String messageId = AiControlApplicationKt.getAppViewModel().getInProgressTaskMessageId();
    ...
    private boolean hasStoragePermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.R) {
            ...
            return ContextCompat.checkSelfPermission(
                    AiControlApplication.Companion.getInstance(),

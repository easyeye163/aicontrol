...
public class GetInstalledAppsTool extends BaseTool {
    ...
    public String getDisplayName() {
        return AiControlApplication.Companion.getInstance().getString(R.string.tool_name_get_installed_apps);
    }
    ...
    public ToolResult execute(Map<String, Object> params) {
        ...
        try {
            PackageManager pm = AiControlApplication.Companion.getInstance().getPackageManager();

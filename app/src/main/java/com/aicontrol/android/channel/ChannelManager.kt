...
import com.aicontrol.android.channel.dingtalk.DingTalkChannelHandler
import com.aicontrol.android.channel.discord.DiscordChannelHandler
import com.aicontrol.android.channel.feishu.FeiShuChannelHandler
import com.aicontrol.android.channel.qqbot.QQChannelHandler
import com.aicontrol.android.channel.telegram.TelegramChannelHandler
import com.aicontrol.android.channel.wechat.WeChatChannelHandler
...
object ChannelManager {
    ...
    fun dispatchMessage(channel: Channel, message: String, messageID: String) {
        try {
            ...
            XLog.e(TAG, "Error in dispatchMessage for ${channel.displayName}", e)
        }
    }
}
